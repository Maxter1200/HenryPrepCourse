...
function promedioResultadosTest(resultadosTest) {
   ...
   // Tu código:
   var prom = 0;
   resultadosTest.forEach((num) => {prom = prom + num });
...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   var max=0;
   arrayOfNums.forEach((num) => { if(num>max) max=num; });
   return max;
...
function cuentoElementos(array) {
   ...
   // Tu código:
   var cant18 = 0;
   array.forEach((num) => { if(num > 18) cant18++; });
   return cant18;
}
...
function mayorACien(array) {
   ...
   // Tu código:
   return array.filter((num) => { if(num > 100) return num; })
}
